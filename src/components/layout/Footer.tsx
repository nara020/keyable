            ...
            <ul className="space-y-2" role="list">
              <li>
                <Link
                  ...
                  className="text-sm text-gray-600 hover:text-[#040f77] dark:text-gray-400 dark:hover:text-[#fc645f]"
                >
                  {dict.nav.services}
                </Link>
              </li>
          ...
          <address className="not-italic">
            ...
            <ul className="space-y-3" role="list">
              <li className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href={`tel:${SITE_CONFIG.phone}`} className="hover:text-[#040f77] focus:outline-none focus:ring-2 focus:ring-blue-500 rounded">
                  {SITE_CONFIG.phone}
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                <Mail className="h-4 w-4" aria-hidden="true" />
                <a href={`mailto:${SITE_CONFIG.email}`} className="hover:text-[#040f77] focus:outline-none focus:ring-2 focus:ring-blue-500 rounded">
                  {SITE_CONFIG.email}
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-3" role="list" aria-label="Social media links">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-100 text-gray-600 transition-colors hover:bg-blue-100 hover:text-[#040f77] dark:bg-gray-800 dark:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
