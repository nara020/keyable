...
const features = [
  ...
  'English & Indonesian Speaking Guides',
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
                We combine local expertise with global service standards to deliver
                unforgettable Korea experiences tailored to your needs.
              </p>
              ...
              <div className="aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/20 dark:to-cyan-900/20">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <Star className="mx-auto h-16 w-16 text-blue-500" />
                    <p className="mt-4 text-xl font-semibold text-gray-900 dark:text-white">
                      Premium Service
                    </p>
                    <p className="text-gray-600 dark:text-gray-400">Since 2019</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-cyan-600 py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-blue-100">
            Let us create your perfect Korean experience. Get a free consultation today.
          </p>
